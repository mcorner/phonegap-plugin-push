...
var PushNotification = function(options) {
    ...
    if ('serviceWorker' in navigator && 'MessageChannel' in window) {
        ...
        let messaging = null;
        load.js('https://www.gstatic.com/firebasejs/4.1.3/firebase-app.js').then(function(){
          return load.js('https://www.gstatic.com/firebasejs/4.1.3/firebase-messaging.js');
        }).then(function(){
